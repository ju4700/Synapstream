        ...
        <section id="contact" className="w-full max-w-[1320px] mx-auto px-4 md:px-8 mt-24 mb-16 relative z-20">
            <div className="border-t border-black/10 pt-16 flex flex-col md:flex-row items-start justify-between gap-16 xl:gap-24">
                ...
                <div className="flex-1 w-full md:ml-12 xl:ml-24">
                    ...
                    >
                        <input type="hidden" name="_autoresponse" value="Thank you for contacting Synapstream. We have received your inquiry regarding APEX-IDS2026 API access and enterprise integration. A member of our engineering team will review your credentials and respond shortly to schedule a consultation." />
